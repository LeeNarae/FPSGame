...
public class Weapon : MonoBehaviour
{
    ...
    public Transform firingPosition;//총알이 나갈 곳
    ...
    void RaycastFire()
    {
        ...
        if (Physics.Raycast(r, out hit, 1000)) //hitPosition 빛이 부딪혔다.
        {
        ...
        if (trailPrefab != null)
        {
            ...
            StartCoroutine(RemoveTrail(obj)); //Coroutine은 괄호 안의 함수를 호출하고 결과를 기다리지 않고 다음꺼 실행
        }
    ...
    {
        yield return new WaitForSeconds(0.3f); // yield 함수로 멈출 수 있음
